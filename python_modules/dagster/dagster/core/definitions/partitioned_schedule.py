...
def schedule_from_partitioned_job(
    job: JobDefinition,
    ...
    check.invariant(
        ...
        "Cannot provide both day_of_month and day_of_week parameter to schedule_from_partitioned_job.",
    )
...
schedule_from_partitions = schedule_from_partitioned_job
