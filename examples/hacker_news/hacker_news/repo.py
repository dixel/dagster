from dagster import repository, schedule_from_partitioned_job
...
def hacker_news_prod():
    return [
        schedule_from_partitioned_job(download_prod_job),
...
def hacker_news_staging():
    return [
        schedule_from_partitioned_job(download_staging_job),
