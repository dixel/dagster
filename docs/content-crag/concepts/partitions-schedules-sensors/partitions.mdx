...
| <PyObject object="schedule_from_partitioned_job" />        | A function that constructs a schedule whose interval matches the partitioning of a partitioned job. |
...
The <PyObject object="schedule_from_partitions"/> function allows you to construct a schedule whose interval matches the spacing of partitions in your job.
